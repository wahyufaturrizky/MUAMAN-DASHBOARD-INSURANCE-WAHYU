...
<ol class="breadcrumb">
    ...
    <li class="active">Update Asuransi</li>
</ol>
</section>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group <?php if(form_error('display_name')) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" name="display_name" value="<?php echo $asuransi->name; ?>">
                    ...
                    <div class="form-group <?php if(form_error('email')) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" name="email" value="<?php echo $asuransi->email; ?>">
                    ...
                    <div class="form-group <?php if(form_error('alamat')) echo 'has-error'; ?>">
                        ...
                        <textarea rows="6" class="form-control" name="alamat"><?php echo $asuransi->address; ?></textarea>
                    ...
                    <div class="form-group <?php if(form_error('phone')) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" name="phone" value="<?php echo $asuransi->telp; ?>">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group <?php if(form_error('username')) echo 'has-error'; ?>">
                        ...
                        <input disabled type="text" class="form-control" name="username" value="<?php echo $asuransi->username_xxx; ?>">
                        <input type="hidden" name="iduser" value="<?php echo $asuransi->id_user;?>"
