         ...
         <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title text-green">REGISTRASI NASABAH</h3>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header bg-blue color-palette">
              ...
              <h4 class="modal-title" id="myModalLabelupdate">REGISTRASI NASABAH</h4> <br>
            </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                          <div class="form-group">     
                            <select class="form-control entries" id="type">
                            <option value="">PILIH TYPE NASABAH</option>
                                <?php
                                  foreach ($gettype->result() as $res) {
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                          <div class="form-group">     
                               <input type="text" class="form-control" id="searchbank" name="nama" placeholder="Keyword Nama Bank (min 5 karakter)">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4">
                          <div class="form-group">     
                            <select class="form-control" id="namabank">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9"> 
                          <div class="form-group"> 
                            <input type="text" class="form-control entries" id="nama" name="nama" placeholder="Nama">
