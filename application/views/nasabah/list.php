<div class="content-wrapper">
    ...
    <h1>
        Nasabah &nbsp; <a href="<?=base_url('nasabah/add')?>" class="btn bg-purple"> <i class="fa fa-edit"></i> Tambah Nasabah </a>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?=base_url('')?>"><i class="fa fa-dashboard"></i> Beranda</a></li>
        <li><a href="<?=base_url('nasabah')?>">Nasabah</a></li>
        <li class="active">List Nasabah</li>
    </ol>
    </section>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <td>
                                ...
                                <a href="<?=base_url('nasabah/edit/'.$row->id)?>" class="btn bg-olive"><i class="fa fa-fw fa fa-edit"></i> Ubah </a>&nbsp;&nbsp;
