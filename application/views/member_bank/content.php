         ...
         <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title text-green">MEMBER BANK</h3>
            ...
            <div class="row">
              <div class="col-sm-3 form-group">
                <select class="form-control" id="asuransi">
                      ...
                      <?php foreach ($master_nasabah as $r) :?>
                        <option value="<?php echo $r->idapm_user;?>"><?php echo $r->name;?></option>
                      <?php endforeach; ?>
                </select>
              </div>
              <div class="col-sm-4">
               ...
               <table id="example1" class="table table-bordered table-striped row-border highlight" width="100%">
                    <thead>
                      <tr class="bg-green">
                       ...
                       <td><b>MEMBER TEMPAT LAHIR</b></td>
                       <td><b>MEMBER TANGGAL LAHIR</b></td>
                       <td><b>MEMBER JENIS KELAMIN</b></td>
                      </tr> 
                    </thead>
                    <tbody>
