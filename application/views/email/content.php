         ...
         <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title text-blue">Manual Email</h3>
            ...
            <div class="col-sm-2 form-group">
              <button type="button" class="btn btn-info btn-flat form-control" id="new"><i class="fa fa-save"></i> <b>EMAIL BARU</b></button>
            </div>
          ...
          <div class="col-sm-12 form-group">
             <table id="example1" class="table table-bordered table-striped row-border highlight" width="100%">
                  <thead>
                    <tr class="bg-green">
                     <td><b>ALAMAT EMAIL TUJUAN</b></td>
                     <td><b>KONTEN EMAIL</b></td> 
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header bg-blue color-palette">
              ...
              <h4 class="modal-title" id="myModalLabelupdate">NEW EMAIL</h4> <br>
            </div>
                    ...
                    <div class="col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                          <div class="form-group">     
                            <input type="text" class="form-control entries" id="email" name="email" placeholder="test1@mail.com,test2@mail.com">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                          <div class="form-group">     
                            <input type="text" class="form-control entries" id="subject" name="subject" placeholder="Subject">
                          </div>
                        </div>
                      </div> 
                      <div class="row">
