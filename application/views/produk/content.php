         ...
         <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title text-blue">REGISTRASI PRODUK</h3>
            ...
            <div class="col-sm-2 form-group">
              <button type="button" class="btn btn-info btn-flat form-control" id="uploadproduk"><i class="fa fa-upload"></i> <b>UPLOAD DATA</b></button>
            </div>
        ...
        <div class="modal-dialog modal-md" role="document">
          <div class="modal-content">
            <div class="modal-header bg-blue color-palette">
              ...
              <h4 class="modal-title" id="myModalLabelupdate">REGISTRASI PRODUK</h4> <br>
            </div>
                    ...
                    <div class="col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                          <div class="form-group">     
                            <input type="text" class="form-control entries" id="nama" name="nama" placeholder="Nama Produk">
      ...
      <div class="modal fade" id="modalupload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?php site_url(); ?>produk/uploadData" method="POST" enctype="multipart/form-data">
              <div class="form-group">
