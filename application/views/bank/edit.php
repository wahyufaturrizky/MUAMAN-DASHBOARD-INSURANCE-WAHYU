    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open('bank/edit/'.$id); ?>
                <div class="box-body">
                    <div class="form-group <?php if(form_error('display_name')) echo 'has-error'; ?>">
                        <label for="nama">Nama</label>
                        <input type="text" class="form-control" name="display_name" value="<?php echo $bank->name; ?>">
                    ...
                    <div class="form-group <?php if(form_error('email')) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" name="email" value="<?php echo $bank->email; ?>">
                    ...
                    <div class="form-group <?php if(form_error('alamat')) echo 'has-error'; ?>">
                        ...
                        <textarea rows="6" class="form-control" name="alamat"><?php echo $bank->address; ?></textarea>
                    ...
                    <div class="form-group <?php if(form_error('phone')) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" name="phone" value="<?php echo $bank->telp; ?>">
