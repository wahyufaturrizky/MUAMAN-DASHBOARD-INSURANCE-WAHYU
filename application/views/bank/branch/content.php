         ...
         <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title text-green">REGISTRASI CABANG  <?php echo strtoupper($parent_name);?></h3>
              <input type="hidden" id="id_parent" value="<?php echo $id_parent;?>">
              <input type="hidden" id="parent_name" value="<?php echo $parent_name;?>">
            ...
            <div class="col-md-12 form-group">
               <table id="example1" class="table table-bordered table-striped row-border highlight" width="100%">
                    <thead>
                      <tr class="color-palette" style="background: #f3f3f3">
                       <td><b>BANK</b></td>
                       <td><b>ALAMAT</b></td>
                       <td><b>EMAIL</b></td>
                       <td><b>TELP</b></td>
        ...
        <div class="modal-dialog modal-md" role="document">
          <div class="modal-content">
            <div class="modal-header bg-blue color-palette">
              ...
              <h4 class="modal-title" id="myModalLabelupdate">REGISTRASI BANK</h4> <br>
            </div>
                    ...
                    <div class="col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                          <div class="form-group">     
                            <input type="text" class="form-control entries" id="nama" name="nama" placeholder="Nama Bank">
