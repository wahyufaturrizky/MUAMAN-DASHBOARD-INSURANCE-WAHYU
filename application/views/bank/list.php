                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <td>
                                ...
                                <!-- <a href="<?=base_url('bank/user/'.$row->id)?>" class="btn btn-info"><i class="fa fa-fw fa-user"></i> Pengguna </a>&nbsp;&nbsp; -->
                                <a href="<?=base_url('branch/'.$row->id)?>" class="btn btn-warning"><i class="fa fa-fw fa-share-alt"></i> Branch </a>&nbsp;&nbsp;
                                <a href="<?=base_url('bank/edit/'.$row->id)?>" class="btn bg-olive"><i class="fa fa-fw fa fa-edit"></i> Ubah </a>&nbsp;&nbsp;
