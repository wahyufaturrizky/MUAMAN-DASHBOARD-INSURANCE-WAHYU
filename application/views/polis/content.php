 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <div id="polissaved">
          <?php $this->view('polis/datapolis'); ?>
        </div>
        <div class="row" id="form_all">
          <div class="col-sm-5">   
            <?php $this->view('polis/datanasabah'); ?>
            <?php $this->view('polis/dataasset'); ?>
          </div>
          <div class="col-sm-7">
            <?php $this->view('polis/dataasuransi',$getproduk); ?>
          </div>
        </div>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
