            <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title text-blue">DATA ASSET</h3>
               ...
               <form method="post" id="forminput1">
                <div class="col-sm-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8">
                      <div class="form-group">     
                        <input type="text" class="form-control entries2" id="tsi" name="nama" placeholder="Nilai Asset Rp">
                        <!-- <input type="hidden" class="form-control entries2" id="tsi"> -->
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8">
                      <div class="form-group">     
                        <textarea class="form-control entries2" id="address" rows="3"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
