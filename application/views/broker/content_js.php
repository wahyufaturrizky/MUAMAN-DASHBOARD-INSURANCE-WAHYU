...
function datatablepaging() {
   $.ajax({
      url :"<?php echo site_url();?>registrasi/broker/paging?search="+$('#contain').val(),
      type:"POST",
      data:{
        },
...
function datatableview(i) {
      $('#example1').dataTable({ 
         ...
         "sScrollXInner": "100%" ,
         "searching" :false,    
        "ajax": "<?php echo site_url()?>registrasi/broker/ajax_data/?page="+i+"&search="+$('#contain').val()
      });
