        ...
        <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title text-blue">REGISTRASI PENGGUNA BROKER <?php echo strtoupper($broker_name);?></h3>
              <input type="hidden" id="id_broker" value="<?php echo $id_broker;?>">
        ...
        <div class="modal-dialog modal-md" role="document">
          <div class="modal-content">
            <div class="modal-header bg-blue color-palette">
              ...
              <h4 class="modal-title" id="myModalLabelupdate">REGISTRASI PENGGUNA</h4> <br>
            </div>
                    ...
                    <div class="col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                          <div class="form-group">     
                            <input type="text" class="form-control entries" id="nama" name="nama" placeholder="Nama Pengguna">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9">
                          <div class="form-group">     
                            <select class="form-control entries" id="part_of_id">
                                <?php foreach ($part_of_id->result() as $row) {
                                  echo'<option value="'.$row->id.'">'.$row->brokerdetailpos.'</option>';
                                } ?>
                            </select>
                          </div>
                        </div>
                  ...
                  <form method="post" id="form_user">
                    <div class="col-sm-12">
                     ...
                     <div class="row">
                      ...
                      <input type="hidden" id="brokergroup">
