            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group <?php if(form_error('display_name')) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="dn" name="display_name" value="<?php echo $userBroker->name; ?>">
                    ...
                    <div class="form-group <?php if(form_error('email')) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" id="email" name="email" value="<?php echo $userBroker->email; ?>">
                    ...
                    <div class="form-group <?php if(form_error('part')) echo 'has-error'; ?>">
                        ...
                        <select id="part" name="part" class="form-control">
                            ...
                            <option <?=($userBroker->part_of_id == 1)?'selected':''?> value="1">Admin</option>
                            <option <?=($userBroker->part_of_id == 2)?'selected':''?> value="2">Registrasi</option>
                            <option <?=($userBroker->part_of_id == 3)?'selected':''?> value="3">Teknik</option>
                            <option <?=($userBroker->part_of_id == 4)?'selected':''?> value="4">Finance</option>
                        </select>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group <?php if(form_error('username')) echo 'has-error'; ?>">
                        ...
                        <input disabled type="text" class="form-control" name="username" value="<?php echo $userBroker->username_xxx; ?>">
                        <input type="hidden" name="iduser" value="<?php echo $userBroker->id_user;?>"
