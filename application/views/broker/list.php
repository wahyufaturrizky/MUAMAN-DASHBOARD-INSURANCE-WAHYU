<div class="content-wrapper">
    ...
    <h1>
        Broker &nbsp; <a href="<?=base_url('broker/add')?>" class="btn bg-purple"> <i class="fa fa-edit"></i> Tambah Broker </a>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?=base_url('')?>"><i class="fa fa-dashboard"></i> Beranda</a></li>
        <li><a href="<?=base_url('broker')?>">Broker</a></li>
        <li class="active">List Broker</li>
    </ol>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <h3 class="box-title">List Broker</h3>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <td>
                                ...
                                <a href="<?=base_url('broker/user/'.$row->id)?>" class="btn bg-olive"><i class="fa fa-fw fa fa-edit"></i> Pengguna </a>&nbsp;&nbsp;
                                <a href="<?=base_url('broker/edit/'.$row->id)?>" class="btn bg-olive"><i class="fa fa-fw fa fa-edit"></i> Ubah </a>&nbsp;&nbsp;
