                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                          <div class="form-group">     
                              <input type="text" id="policy_cost" class="form-control currency" style="text-align: right">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                          <div class="form-group">     
                              <input type="text" id="stamp_duty" class="form-control currency" style="text-align: right">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-xs-12 col-sm-4">
                          <div class="form-group">     
                            <label>BIAYA ADMIN INTERNAL</label>
                          </div>
                        </div>
                        <div class="col-xs-12 col-sm-8">
                          <div class="form-group">     
                              <input type="text" id="internal_admin_cost" class="form-control currency" style="text-align: right">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                          <div class="form-group">     
                              <input type="text" id="insurer_admin_cost" class="form-control currency" style="text-align: right">
                          </div>
                        </div>
                      </div>
