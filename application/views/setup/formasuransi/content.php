 <!-- Content Wrapper. Contains page content -->
         ...
         <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title text-green">SETUP FORM ASURANSI</h3>
              ...
              <div class="col-md-12 form-group">
               <table id="example1" class="table table-bordered table-striped row-border highlight" width="100%">
                    <thead>
                      <tr class="bg-green">
                       <td><b>FIELD ID</b></td>
                       <td><b>FIELD CAPTION</b></td>
                       <td><b>EDIT </b></td>
                       <td><b>DELETE </b></td>
                       <td><b>PREVIEW FORM</b></td>
                       <td><b>CSV TEMPLATE</b></td>
                      </tr> 
                    </thead>
                    <tbody>
  ...
  <?php  
    $this->view('setup/formasuransi/modalform'); 
  ?>
  <?php  
    $this->view('setup/formasuransi/modalsuccess'); 
  ?>
  <?php  
    $this->view('setup/formasuransi/modalwarning'); 
  ?>
  <?php  
    $this->view('setup/formasuransi/modalerror'); 
  ?>
  <?php  
    $this->view('setup/formasuransi/modaldelete'); 
  ?>
