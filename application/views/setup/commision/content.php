 <!-- Content Wrapper. Contains page content -->
         ...
         <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title text-green">SETUP COMMISION</h3>
               ...
               <table id="example1" class="table table-bordered table-striped row-border highlight" width="100%">
                    <thead>
                      <tr class="bg-green">
                       ...
                       <td><b>ID THIRD PARTY </b></td>
                       <td><b>KATEGORI KOMISI</b></td>
                       <td><b>TIPE KOMISI</b></td>
                       <td><b>RATE KOMISI</b></td>
                       <td><b>AMOUNT KOMISI</b></td>
                       <td><b>EDIT </b></td>
                       <td><b>DELETE </b></td>
                      </tr> 
                    </thead>
  ...
  <?php  
    $this->view('setup/commision/modalform'); 
  ?>
  <?php  
    $this->view('setup/commision/modalsuccess'); 
  ?>
  <?php  
    $this->view('setup/commision/modalwarning'); 
  ?>
  <?php  
    $this->view('setup/commision/modalerror'); 
  ?>
  <?php  
    $this->view('setup/commision/modaldelete'); 
  ?>
  <?php  
   //$this->view('setup/commision/modalupload'); 
  ?>
